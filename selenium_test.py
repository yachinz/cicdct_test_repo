...
class BrowserTest:
    ...
    def check_redirect(self):
        ...
        try:
            ...
            print(
                "Falied, redirect_link 1: http://localhost:5000/aloEv2, https://github.com/yachinz/format_test")
        ...
        try:
            ...
            print("Failed, redirect_link 2: http://localhost:5000/4nSynq, https://github.com/yachinz/live2d-widget")
        ...
        try:
            ...
            print("Failed, redirect_link 3: http://localhost:5000/1JbS5c, https://github.com/yachinz/easy-animator")
        ...
        try:
            ...
            print("Failed, redirect_link 4: http://localhost:5000/6UErY0, https://github.com/yachinz/live2d-widget")
